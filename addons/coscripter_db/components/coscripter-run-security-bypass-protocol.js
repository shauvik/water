...
const kPROTOCOL_NAME = "CoScripterRun Security Bypass Protocol";
...
Protocol.prototype =
{
  ...
  newChannel: function(aURI)
  {
    ...
    if (url.match(/^[^:]+:(.*)/)) {
        ...
        var mainChromeWindow = u.mostRecentMainWindow();
...
{
  //dump("*** registration of coscript-run protocol handler component\n");
